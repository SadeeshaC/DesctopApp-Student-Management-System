...
public class ViewAttendance extends javax.swing.JFrame {
    ...
    private void LoadTable() {
        try {
            ...
            String corses = String.valueOf(jComboBox1.getSelectedItem());
            ...
            if (!stID.isEmpty()) {
                ResultSet resultSet = MySQL.execute("SELECT * FROM `attendance` INNER JOIN `students` ON `attendance`.`Students_StudentID`=`students`.`StudentID`\n"
                        ...
                        + "ON `attendance`.`AttendanceStatus_ID`=`attendancestatus`.`ID` WHERE `StudentID`="+stID+"");
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Attendance View & Search");
        ...
        jLabel1.setText("To");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 170, 70, -1));
        ...
        jPanel1.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 170, 160, -1));

        jDateChooser2.setDateFormatString("yyyy-MM-dd");
        jPanel1.add(jDateChooser2, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 170, 160, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Student ID");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 130, 70, -1));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Date");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 170, 40, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 162, 220, 30));
